...
//! with [`entries`](FileSystemSource::entries), which yields `(name, child)`
//! pairs. A child carries cached metadata, and its directory handle is
//! opened only when you descend into it.
//!
//! # Write side
//!
