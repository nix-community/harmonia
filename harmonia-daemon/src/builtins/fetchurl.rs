...
pub(crate) async fn builtin_fetchurl(
    ...
    if let Some(file_path) = url.strip_prefix("file://") {
        ...
        if unpack {
            ...
            let events = harmonia_file_nar::parse_nar(cursor);
            ...
            harmonia_file_nar::restore(mapped, &dest)
                .await
...
mod tests {
    ...
    use harmonia_store_derivation::derivation::{DerivationOutput, DerivationT};
    use harmonia_store_derivation::derived_path::OutputName;
